...
from yourscrapers.modules.control import existsPath, dataPath, makeFile, cacheFile
...
import xbmc
from yourscrapers.modules.control import joinPath, transPath, addonInfo, existsPath, makeFile
