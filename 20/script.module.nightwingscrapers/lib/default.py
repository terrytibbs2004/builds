...
from nightwingscrapers import sources_nightwingscrapers
from nightwingscrapers.modules import control
from nightwingscrapers import providerSources, providerNames
...
def ScraperChoice():
    from nightwingscrapers import providerSources
...
def ToggleProviderAll(enable):
    from nightwingscrapers import providerNames
...
if action == "nightwingscrapersettings":
    control.openSettings('0.0', 'script.module.nightwingscrapers')


elif mode == "nightwingscrapersettings":
    control.openSettings('0.0', 'script.module.nightwingscrapers')
    ...
    sourceList = []
    sourceList = sources_nightwingscrapers.all_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All providers = %s' % sourceList,2)
    control.sleep(200)
    control.openSettings(query, "script.module.nightwingscrapers")
    ...
    sourceList = []
    sourceList = sources_nightwingscrapers.hoster_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Hoster providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_nightwingscrapers.all_foreign_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Foregin providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_nightwingscrapers.greek_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Greek providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_nightwingscrapers.torrent_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
