...
# Addon Name: Team Wolf Pack
# Addon id: plugin.video.wolfpack
# Addon Provider: Team Wolf Pack
...
from WolfPackScrapers.modules import cleantitle, client, source_utils, log_utils
