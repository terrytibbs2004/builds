...
class navigator:
    def root(self):
        ...
        self.addDirectoryItem('ThePromise Movie Lists', 'listsListsNavigator', 'lists.png', 'DefaultMovies.png')
        self.addDirectoryItem('IPTV & Sports', 'iptvListsNavigator', 'iptv.png', 'DefaultTVShows.png')
        self.addDirectoryItem('Retro Cartoons', 'tvshows&url=https://api.trakt.tv/users/sg0/lists/sg0-s-toontv/items', 'retrotoons.png', 'DefaultTVShows.png')
    ...
    def iptv(self, lite=False):
        self.addDirectoryItem('SwiftTv - [COLOR red]19 Only[/COLOR]', 'swifttv', 'swifttv.png', 'DefaultTVShows.png')
        self.addDirectoryItem('TapTv - [COLOR red]18 - 19[/COLOR]', 'taptv', 'taptv.png', 'DefaultTVShows.png')
        self.addDirectoryItem('LnTv - [COLOR red]18 - 19[/COLOR]', 'lntv', 'lntv.png', 'DefaultTVShows.png')
        ...
        self.addDirectoryItem('Pluto - Samsung - Stir - Plex - PBS - Fluxus [COLOR red]18 - 19[/COLOR]', 'm3u', 'm3u.png', 'DefaultTVShows.png')
    ...
    def lists(self, lite=False):
        ...
        self.addDirectoryItem('DcMarvel', 'dcmarvelherosNavigator', 'dcmarvelheros.png', 'DefaultMovies.png')
        self.addDirectoryItem('1Click Movies [COLORspringgreen](FREE)[/COLOR]', 'oneclick', 'movies.png', 'DefaultMovies.png')
        self.endDirectory()

    def user(self, lite=False):
        #self.addDirectoryItem('DiamondBuild [COLORred](Debrid ONLY)[/COLOR]', 'diamondbuild', 'diamondbuild.png', 'DefaultMovies.png')
        self.addDirectoryItem('Insomnia 1Click New Releases[COLORred](Debrid ONLY)[/COLOR]', 'ioneclick', 'insomnia.png', 'DefaultMovies.png')
        self.addDirectoryItem('Insomnia 1Click Horror [COLORred](Debrid ONLY)[/COLOR]', 'ihorror', 'insomnia.png', 'DefaultMovies.png')
        self.addDirectoryItem('NightWing 1Click New Releases [COLORred](Debrid ONLY)[/COLOR]', 'magnetic', 'nightwing.png', 'DefaultMovies.png')
    ...
    def tools(self):
        self.addDirectoryItem('[B]ThePromise[/B] : Changelog', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32043, 'openSettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32079, 'promisescrapersettings', 'iconT.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        self.addDirectoryItem('[B]ThePromise[/B] : Cache Functions', 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[B]ThePromise[/B] : Log Functions', 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def log_functions(self):
        self.addDirectoryItem('[B]ThePromise[/B] : View Log', 'viewLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]ThePromise[/B] : Upload Log to hastebin', 'uploadLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[B]ThePromise[/B] : Empty Log', 'emptyLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
