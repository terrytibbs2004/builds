...
from duffyou_utils.utils import *
...
def downloadpage(url, post=None, headers=None, timeout=5, follow_redirects=True, cookies=True, replace_headers=False,
