...
class sources:
    ...
    def getConstants(self):
        self.itemProperty = 'plugin.video.homelander.container.items'

        self.metaProperty = 'plugin.video.homelander.container.meta'
        ...
        self.module_name = 'homelander:'

        if externalEnabled == 'true':
            try:
                import homelanderscrapers
                self.sourceDict += homelanderscrapers.sources()
                self.module_name = 'homelanderScrapers (' + str(control.addon('script.module.homelanderscrapers').getSetting('package.folder')) + ' set):' \
                                   if control.addon('script.module.homelanderscrapers').getSetting('package.folder') != 'homelanderscrapers' else '[COLOR white]Homelander will find your content[/COLOR]'
            except:
                pass
