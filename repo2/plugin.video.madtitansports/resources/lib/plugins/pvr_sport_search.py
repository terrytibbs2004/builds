...
class DirectSearch(Plugin):
    ...
    def search_include(self):
        r = requests.get(base64.b64decode("aHR0cHM6Ly9tYWduZXRpYzEucmF0cGFjay5hcHBib3hlcy5jby9NQURfVElUQU5fU1BPUlRTL1NQT1JUUy9zZWFyY2hfaW5jbHVkZS5qc29u").decode("utf-8")).json()
        return r
