...
from homelanderscrapers import parse_qs, urljoin, urlparse, urlencode, quote_plus, unquote

from homelanderscrapers.modules import client
from homelanderscrapers.modules import cleantitle
from homelanderscrapers.modules import directstream
...
class source:
    ...
    def movie(self, imdb, title, localtitle, aliases, year):
        try:
            ...
            log_utils.log('fast32 Exception', 1)
            return
    ...
    def sources(self, url, hostDict, hostprDict):
        try:
            ...
            #log_utils.log('fast32 html: ' + html)
