...
from six.moves import urllib_request, urllib_error, http_client, _thread
    ...
    def do_open(self, http_class, req):
        ...
        try:
            ...
            while h:
                ...
                r = h.getresponse()
        except (socket.error, http_client.HTTPException), err:
...
class HTTPResponse(http_client.HTTPResponse):
    ...
    def __init__(self, sock, debuglevel=0, strict=0, method=None):
        if method: # the httplib in python 2.3 uses the method arg
            http_client.HTTPResponse.__init__(self, sock, debuglevel, method)
        else: # 2.2 doesn't
            http_client.HTTPResponse.__init__(self, sock, debuglevel)
    ...
    _raw_read = http_client.HTTPResponse.read
