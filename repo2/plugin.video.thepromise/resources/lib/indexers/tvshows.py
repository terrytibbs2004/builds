...
# User Lists ShadowHawk Tv
        self.shstonertvshows_link = 'https://www.imdb.com/list/ls093291259/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.items_per_page

# User Lists Poison
        self.ibreak_link = 'https://www.imdb.com/list/ls500365647/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.items_per_page
        self.iwow_link = 'https://www.imdb.com/list/ls500293183/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.items_per_page
        self.igos_link = 'https://www.imdb.com/list/ls505000411/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.items_per_page

# User Lists Cable
        self.cabletv_link = 'https://www.imdb.com/list/ls066306505/?view=detail&sort=alpha,asc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.items_per_page
