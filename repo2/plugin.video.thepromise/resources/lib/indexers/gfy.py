...
class indexer:
    ...
    def root(self): #M3u Lists
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/m3u/m3u.xml'
            self.list = self.gfy_list(url)
    ...
    def root_swifttv(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/swifttv/swifttv.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_taptv(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/taptv/taptv.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_lntv(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/lntv/lntv.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_lntvsports(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/lntv/lntvsports.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_rbtv(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/rbtv/rbtv.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_usgotv(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/usgotv/usgotv.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_porn(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/porn/porn.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_pioneclick(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/m3atp1zza/OffSpringRepo/main/text/oneclicks.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_pihorror(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/m3atp1zza/OffSpringRepo/main/text/horrorrd.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_oneclick(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/oneclick/oneclick.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_test(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/test/test.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_music(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/warehousecrates/TheWareHouse/main/text/music/music.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
    ...
    def root_userlists(self):
        try:
            regex.clear()
            url = 'https://raw.githubusercontent.com/techecoyote/LooNaticsAsylum/master/text/userlists/userlists.xml'
            self.list = self.gfy_list(url)
            for i in self.list: i.update({'content': 'addons'})
            self.addDirectory(self.list)
            return self.list
