...
def routing(_argv):
    ...
    ####################################################
        ...
        from resources.lib.indexers import gfy
        ...
        from resources.lib.indexers import gfy
        gfy.indexer().getq(url)
    elif action == 'xdirectory':
        from resources.lib.indexers import gfy
        gfy.indexer().getx(url)
    elif action == 'developer':
        from resources.lib.indexers import gfy
        gfy.indexer().developer()
    elif action == 'tvtuner':
        from resources.lib.indexers import gfy
        gfy.indexer().tvtuner(url)
    elif action == 'gfy_play':
        from resources.lib.indexers import gfy
        if not content == None:
            gfy.player().play(url, content)
        else:
            from resources.lib.modules import sources
            sources.Sources().play(title, year, imdb, tvdb, season, episode, tvshowtitle, premiered, meta, select)
    elif action == 'browser':
        from resources.lib.indexers import gfy
        gfy.resolver().browser(url)


    ####################################################
    #--- IPTV
    ####################################################
    elif action == 'iptvListsNavigator':
        from resources.lib.indexers import navigator
    ...
    #--- Loonatics Lists
    ####################################################
    elif action == 'listsListsNavigator':
        from resources.lib.indexers import navigator
        navigator.navigator().lists()

    elif action == 'userListsNavigator':
        from resources.lib.indexers import navigator
        navigator.navigator().user()

    elif action == 'wolfgirl':
        from resources.lib.indexers import navigator
    ...
    elif action == 'diamondbuild':
        from resources.lib.indexers import gfy
        gfy.indexer().root_diamondbuild()

    elif action == 'ioneclick':
        from resources.lib.indexers import gfy
        gfy.indexer().root_pioneclick()

    elif action == 'ihorror':
        from resources.lib.indexers import gfy
        gfy.indexer().root_pihorror()

    elif action == 'dcmarvelbuild':
        from resources.lib.indexers import navigator
    ...
    ####################################################
    #--- NightWing New Releases 1Clicks
    ####################################################
    elif action == 'magnetic':
        from resources.lib.indexers import gfy
        gfy.indexer().root_magnetic()
    ...
    ####################################################
        ...
        from resources.lib.indexers import gfy
        gfy.indexer().root_lntv()


    ####################################################
    #--- LNTv Sports
    ####################################################
    elif action == 'lntvsports':
        from resources.lib.indexers import gfy
        gfy.indexer().root_lntvsports()
    ...
    ####################################################
        ...
        from resources.lib.indexers import gfy
        gfy.indexer().root_usgotv()


    ####################################################
    #--- DC / Marvel SuperHeros
    ####################################################
    elif action == 'dcmarvelherosNavigator':
        from resources.lib.indexers import navigator
    ...
    elif action == 'promisescrapersettings':
        from resources.lib.modules import control
