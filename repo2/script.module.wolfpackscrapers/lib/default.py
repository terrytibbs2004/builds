...
from WolfPackScrapers import sources_WolfPackScrapers
from WolfPackScrapers.modules import control
from WolfPackScrapers import providerSources, providerNames
...
def ScraperChoice():
    from WolfPackScrapers import providerSources
...
def ToggleProviderAll(enable):
    from WolfPackScrapers import providerNames
...
if action == "WolfPackScrapersettings":
    control.openSettings('0.0', 'script.module.wolfpackscrapers')

elif mode == "WolfPackScrapersettings":
    control.openSettings('0.0', 'script.module.wolfpackscrapers')
    ...
    sourceList = []
    sourceList = sources_WolfPackScrapers.all_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All providers = %s' % sourceList,2)
    control.sleep(200)
    control.openSettings(query, "script.module.wolfpackscrapers")
    ...
    sourceList = []
    sourceList = sources_WolfPackScrapers.hoster_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Hoster providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_WolfPackScrapers.all_foreign_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Foregin providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_WolfPackScrapers.greek_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Greek providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_WolfPackScrapers.torrent_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
