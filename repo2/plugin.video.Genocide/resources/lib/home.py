...
class cHome:
    ...
    def load(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'showSearchText', self.addons.VSlang(30076), 'chains.png', oOutputParameterHandler)
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir('freebox', 'load', self.addons.VSlang(30115), 'chains.png', oOutputParameterHandler)
    ...
    def showSearch(self, searchtext=cInputParameterHandler().getValue('searchtext')):
        ...
        oGuiElement.setIcon('chains.png')
        ...
        # oGui.addDir('globalSearch', 'showSearchText', 'self.addons.VSlang(30417), 'chains.png', oOutputParameterHandler)
    ...
    def showReplay(self):
        ...
        oGui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30117), self.addons.VSlang(30101)), 'chains.png', oOutputParameterHandler)
    ...
    def showMovies(self):
        ...
        oGui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30120), self.addons.VSlang(30101)), 'chains.png', oOutputParameterHandler)
    ...
    def showSeries(self):
        ...
        oGui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30121), self.addons.VSlang(30101)), 'chains.png', oOutputParameterHandler)
    ...
    def showAnimes(self):
        ...
        oGui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30122), self.addons.VSlang(30101)), 'chains.png', oOutputParameterHandler)
    ...
    def showDocs(self):
        ...
        oGui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30112), self.addons.VSlang(30101)), 'chains.png', oOutputParameterHandler)
    ...
    def showNets(self):
        ...
        oGui.addDir(SITE_IDENTIFIER, 'callpluging', '%s (%s)' % (self.addons.VSlang(30114), self.addons.VSlang(30101)), 'chains.png', oOutputParameterHandler)
    ...
    def showUsers(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://')
        oGui.addDir('cTrakt', 'getLoad', self.addons.VSlang(30214), 'chains.png', oOutputParameterHandler)
    ...
    def ShowTools(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'showHostDirect', self.addons.VSlang(30469), 'chains.png', oOutputParameterHandler)
    ...
    def showHistory(self):
        ...
        if row:
            oOutputParameterHandler = cOutputParameterHandler()
            oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
            oGui.addDir(SITE_IDENTIFIER, 'delSearch', self.addons.VSlang(30413), 'chains.png', oOutputParameterHandler)
