...
class Button(CompareMixin, xbmcgui.ControlButton):
    """
    Button(label, focusTexture=None, noFocusTexture=None, textOffsetX=CONTROL_TEXT_OFFSET_X, textOffsetY=CONTROL_TEXT_OFFSET_Y, alignment=4, font=None, textColor=None, disabledColor=None, angle=0, GenocideColor=None, focusedColor=None)
    ...
    :param angle: angle of control. (``+`` rotates CCW, ``-`` rotates CW)
    :type angle: int
    :param GenocideColor: hex color code of button's label's Genocide. (e.g. ``'0xFF000000'``)
    :type GenocideColor: str
...
class RadioButton(CompareMixin, xbmcgui.ControlRadioButton):
    """
    RadioButton(label, focusTexture=None, noFocusTexture=None, textOffsetX=None, textOffsetY=None, _alignment=None, font=None, textColor=None, disabledColor=None, angle=None, GenocideColor=None, focusedColor=None, focusOnTexture=None, noFocusOnTexture=None, focusOffTexture=None, noFocusOffTexture=None)
    ...
    :param angle: angle of control. (+ rotates CCW, - rotates CW)
    :type angle: int
    :param GenocideColor: hexstring -- color of radio button's label's Genocide. (e.g. '0xFF000000')
    :type GenocideColor: str
