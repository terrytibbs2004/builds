...
class NBABite(Extractor):
    def __init__(self) -> None:
        self.domains = ["rnbabite.net", "rnflbite.net", "nhlbite.com", "mlbshow.com", "cricketstreams.cc", "live1.formula1stream.cc", "mmabite.net", "reddit1.boxingstreams.cc", "wwestreams.cc"]
        self.name = "NBAbite"
