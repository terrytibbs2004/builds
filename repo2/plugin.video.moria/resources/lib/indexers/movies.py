...
class movies:
    def __init__(self):
        ...
        self.tolkien_link = 'https://api.trakt.tv/users/istoit/lists/tolkien/items'
        ...
        self.top100_link = 'https://www.imdb.com/search/title?title_type=feature&groups=top_100&count=%s&start=1' % self.items_per_page
        self.top250_link = 'https://www.imdb.com/search/title?title_type=feature&groups=top_250&count=%s&start=1' % self.items_per_page
        # self.collections_link = 'https://api.trakt.tv/crims7392/lists/movie-boxsets-collections/items'
...
################# Directors ####################
        self.hitchcock_link = 'https://api.trakt.tv/users/istoit/lists/hitchcock/items'
        self.aronofsky_link = 'https://api.trakt.tv/users/origin14/lists/director-darren-aronofsky/items'
        self.scorsese_link = 'https://api.trakt.tv/users/origin14/lists/director-martin-scorsese/items'
        self.stone_link = 'https://api.trakt.tv/users/origin14/lists/director-oliver-stone/items'
        self.coppola_link = 'https://api.trakt.tv/users/origin14/lists/director-francis-ford-coppola/items'
        self.kubrick_link = 'https://api.trakt.tv/users/origin14/lists/director-stanley-kubrick/items'
        self.depalma_link = 'https://api.trakt.tv/users/origin14/lists/director-brian-de-palma/items'
        self.reiner_link = 'https://api.trakt.tv/users/origin14/lists/director-rob-reiner/items'
        self.howard_link = 'https://api.trakt.tv/users/origin14/lists/director-ron-howard/items'
        self.gibson_link = 'https://api.trakt.tv/users/istoit/lists/mel-gibson/items'
        self.coen_link = 'https://api.trakt.tv/users/origin14/lists/director-coen-brothers/items'
        self.lynch_link = 'https://api.trakt.tv/users/origin14/lists/director-david-lynch/items'
        self.ritchie_link = 'https://api.trakt.tv/users/origin14/lists/director-guy-ritchie/items'
        self.tarantino_link = 'https://api.trakt.tv/users/istoit/lists/tarantino-greats/items'
        self.rodriguez_link = 'https://api.trakt.tv/users/origin14/lists/director-robert-rodriguez/items'
        self.night_link = 'https://api.trakt.tv/users/origin14/lists/director-m-night-shyamalan/items'
        self.guillermo_link = 'https://api.trakt.tv/users/origin14/lists/director-guillermo-del-toro/items'
        self.peele_link = 'https://api.trakt.tv/users/istoit/lists/jordan-peele/items'
        self.wan_link = 'https://api.trakt.tv/users/istoit/lists/james-wan/items'
        self.burton_link = 'https://api.trakt.tv/users/origin14/lists/director-tim-burton/items'
        self.raimi_link = 'https://api.trakt.tv/users/origin14/lists/director-sam-raimi/items'
        self.romero_link = 'https://api.trakt.tv/users/istoit/lists/george-romero/items'
        self.craven_link = 'https://api.trakt.tv/users/origin14/lists/director-wes-craven/items'
        self.carpenter_link = 'https://api.trakt.tv/users/origin14/lists/director-john-carpenter/items'
        # self.hooper_link = 'https://api.trakt.tv/users/istoit/lists/tobe-hooper/items'
        self.ridley_link = 'https://api.trakt.tv/users/origin14/lists/director-ridley-scott/items'
        self.cameron_link = 'https://api.trakt.tv/users/origin14/lists/director-james-cameron/items'
        self.spielberg_link = 'https://api.trakt.tv/users/origin14/lists/director-steven-spielberg/items'
        self.lucas_link = 'https://api.trakt.tv/users/istoit/lists/george-lucas/items'
        self.jackson_link = 'https://api.trakt.tv/users/origin14/lists/director-peter-jackson/items'
        self.eastwood_link = 'https://api.trakt.tv/users/origin14/lists/director-clint-eastwood/items'
        self.nolan_link = 'https://api.trakt.tv/users/origin14/lists/director-christopher-nolan/items'
        self.villeneuve_link = 'https://api.trakt.tv/users/origin14/lists/director-denis-villeneuve/items'
        self.fincher_link = 'https://api.trakt.tv/users/origin14/lists/director-david-fincher/items'
        self.boyle_link = 'https://api.trakt.tv/users/origin14/lists/director-danny-boyle/items'
        self.waititi_link = 'https://api.trakt.tv/users/origin14/lists/director-taika-waititi/items'
        self.wright_link = 'https://api.trakt.tv/users/origin14/lists/director-edgar-wright/items'
        self.wes_link = 'https://api.trakt.tv/users/origin14/lists/director-wes-anderson/items'


################# Collections ####################
        self.lotr_link = 'https://api.trakt.tv/users/istoit/lists/middle-earth-movies/items'
        self.wizard_link = 'https://api.trakt.tv/users/rzepkowski/lists/wizarding-world-movies/items'
        self.mcu_link = 'https://api.trakt.tv/users/rzepkowski/lists/marvel-mcu-movies/items'
        self.sony_link = 'https://api.trakt.tv/users/rzepkowski/lists/sony-s-marvel-universe/items'
        self.xmen_link = 'https://api.trakt.tv/users/rzepkowski/lists/x-men-movies/items'
        self.spiderman_link = 'https://api.trakt.tv/users/istoit/lists/spider-man-movies/items'
        self.deadpool_link = 'https://api.trakt.tv/users/istoit/lists/deadpool-collection/items'
        self.dc_link = 'https://api.trakt.tv/users/rzepkowski/lists/dc-extended-universe-movies/items'
        self.batman_link = 'https://api.trakt.tv/users/rzepkowski/lists/batman-movies/items'
        self.unbreak_link = 'https://api.trakt.tv/users/rzepkowski/lists/unbreakable-movies/items'
        self.hellboy_link = 'https://api.trakt.tv/users/rzepkowski/lists/hellboy-movies/items'
        self.matrix_link = 'https://api.trakt.tv/users/rzepkowski/lists/the-matrix-movies/items'
        self.starwars_link = 'https://api.trakt.tv/users/rzepkowski/lists/star-wars-movies/items'
        self.trekkie_link = 'https://api.trakt.tv/users/rzepkowski/lists/star-trek-movies/items'
        self.avatar_link = 'https://api.trakt.tv/users/rzepkowski/lists/avatar-movies/items'
        self.monster_link = 'https://api.trakt.tv/users/rzepkowski/lists/monsterverse-movies/items'
        self.jurassic_link = 'https://api.trakt.tv/users/rzepkowski/lists/jurassic-park-movies/items'
        self.narnia_link = 'https://api.trakt.tv/users/rzepkowski/lists/the-chronicles-of-narnia-movies/items'
        self.pirates_link = 'https://api.trakt.tv/users/rzepkowski/lists/pirates-of-the-caribbean-movies/items'
        self.mummy_link = 'https://api.trakt.tv/users/rzepkowski/lists/the-mummy-movies/items'
        self.indiana_link = 'https://api.trakt.tv/users/rzepkowski/lists/indiana-jones-movies/items'
        self.treasure_link = 'https://api.trakt.tv/users/rzepkowski/lists/national-treasure-movies/items'
        self.seeme_link = 'https://api.trakt.tv/users/rzepkowski/lists/now-you-see-me-movies/items'
        self.oceans_link = 'https://api.trakt.tv/users/rzepkowski/lists/ocean-s-eleven-movies/items'
        self.wick_link = 'https://api.trakt.tv/users/rzepkowski/lists/john-wick-movies/items'
        self.mission_link = 'https://api.trakt.tv/users/rzepkowski/lists/mission-impossible-movies/items'
        self.bourne_link = 'https://api.trakt.tv/users/rzepkowski/lists/jason-bourne-movies/items'
        # self.ryan_link = 'https://api.trakt.tv/users/rzepkowski/lists/jack-ryan-movies/items'
        self.jack_link = 'https://www.imdb.com/list/ls563157559/?view=detail&sort=date,desc&title_type=movie,short,tvMovie&start=1'
        self.bond_link = 'https://api.trakt.tv/users/istoit/lists/bond-james-bond/items'
        self.kingsman_link = 'https://api.trakt.tv/users/rzepkowski/lists/kingsman-movies/items'
        self.killbill_link = 'https://api.trakt.tv/users/istoit/lists/kill-bill/items'
        self.twilight_link = 'https://api.trakt.tv/users/rzepkowski/lists/twilight-saga-movies/items'
        self.fifty_link = 'https://api.trakt.tv/users/rzepkowski/lists/fifty-shades-movies/items'
        self.fast_link = 'https://api.trakt.tv/users/rzepkowski/lists/the-fast-and-the-furious-movies/items'
        self.max_link = 'https://api.trakt.tv/users/rzepkowski/lists/mad-max-movies/items'
        self.games_link = 'https://api.trakt.tv/users/rzepkowski/lists/the-hunger-games-movies/items'
        self.apes_link = 'https://api.trakt.tv/users/rzepkowski/lists/planet-of-the-apes-movies/items'
        self.riddick_link = 'https://api.trakt.tv/users/rzepkowski/lists/riddick-movies/items'
        self.terminator_link = 'https://api.trakt.tv/users/rzepkowski/lists/terminator-movies/items'
        self.python_link = 'https://api.trakt.tv/users/rzepkowski/lists/monty-python-movies/items'
        self.powers_link = 'https://api.trakt.tv/users/rzepkowski/lists/austin-powers-movies/items'
        self.gun_link = 'https://api.trakt.tv/users/rzepkowski/lists/the-naked-gun-movies/items'
        self.ace_link = 'https://api.trakt.tv/users/rzepkowski/lists/ace-ventura-movies/items'
        self.rush_link = 'https://api.trakt.tv/users/rzepkowski/lists/rush-hour-movies/items'
        self.fockers_link = 'https://api.trakt.tv/users/istoit/lists/the-fockers-movies/items'
        self.scary_link = 'https://api.trakt.tv/users/rzepkowski/lists/scary-movie-movies/items'
        self.black_link = 'https://api.trakt.tv/users/rzepkowski/lists/men-in-black-movies/items'
        self.alien_link = 'https://api.trakt.tv/users/rzepkowski/lists/alien-and-predator-movies/items'
        self.quiet_link = 'https://api.trakt.tv/users/rzepkowski/lists/a-quiet-place-movies/items'
        self.it_link = 'https://api.trakt.tv/users/rzepkowski/lists/it-movies/items'
        self.destination_link = 'https://api.trakt.tv/users/rzepkowski/lists/final-destination-movies/items'
        self.conjuring_link = 'https://api.trakt.tv/users/rzepkowski/lists/the-conjuring-movies-chronology/items'
        self.insidious_link = 'https://api.trakt.tv/users/rzepkowski/lists/insidious-movies/items'
        self.purge_link = 'https://api.trakt.tv/users/rzepkowski/lists/the-purge-movies/items'
        self.saw_link = 'https://api.trakt.tv/users/rzepkowski/lists/saw-movies/items'
        self.evildead_link = 'https://api.trakt.tv/users/rzepkowski/lists/evil-dead-movies/items'
        self.livingdead_link = 'https://api.trakt.tv/users/istoit/lists/the-living-dead-collection/items'
        self.halloween_link = 'https://api.trakt.tv/users/rzepkowski/lists/halloween-movies/items'
        self.friday_link = 'https://api.trakt.tv/users/rzepkowski/lists/friday-the-13th-and-a-nightmare-on-elm-street-movies/items'
        self.xmas_link = 'https://api.trakt.tv/users/istoit/lists/christmas-movies/items'
        self.lee_link = 'https://api.trakt.tv/users/istoit/lists/bruce-lee/items'
    ...
    def keywords(self): # Poseidon lists (by Soulless)
        keywords = [
            ('anime', 'imdb.png'),
