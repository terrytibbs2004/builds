...
class cHome:
    ...
    def load(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'showSearchText', self.addons.VSlang(30076), 'basic.png', oOutputParameterHandler)
    ...
    def showSearch(self, searchtext=cInputParameterHandler().getValue('searchtext')):
        ...
        # oGui.addDir('globalSearch', 'showSearchText', 'self.addons.VSlang(30417), 'basic.png', oOutputParameterHandler)
    ...
    def showUsers(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://')
        oGui.addDir('cTrakt', 'getLoad', self.addons.VSlang(30214), 'basic.png', oOutputParameterHandler)
    ...
    def ShowTools(self):
        ...
        oOutputParameterHandler = cOutputParameterHandler()
        oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
        oGui.addDir(SITE_IDENTIFIER, 'showHostDirect', self.addons.VSlang(30469), 'basic.png', oOutputParameterHandler)
    ...
    def showHistory(self):
        ...
        if row:
            oOutputParameterHandler = cOutputParameterHandler()
            oOutputParameterHandler.addParameter('siteUrl', 'http://venom')
            oGui.addDir(SITE_IDENTIFIER, 'delSearch', self.addons.VSlang(30413), 'basic.png', oOutputParameterHandler)
