...
colorChart = ['black', 'lime', 'whitesmoke', 'gainsboro', 'lightgray', 'silver', 'darkgray', 'gray', 'dimgray',
              ...
              'powderblue', 'lime', 'skyblue', 'lightskyblue', 'deepskyblue', 'dodgerblue', 'royalblue',
              ...
              'aqua', 'aquamarine', 'chartreuse', 'greenyellow', 'palegreen', 'lawngreen', 'lime', 'lime',
              ...
              'darkkhaki', 'lime', 'lime', 'goldenrod', 'lightyellow', 'lightgoldenrodyellow', 'lemonchiffon',
              'lime', 'seashell', 'lavenderblush', 'lavender', 'lightcoral', 'indianred', 'darksalmon',
              'lightsalmon', 'lime', 'lightpink', 'hotpink', 'magenta', 'lime', 'violet', 'orchid', 'palevioletred',
              ...
              'sandybrown', 'lime', 'chocolate', 'orange', 'darkorange', 'tomato', 'orangered', 'lime', 'crimson',
