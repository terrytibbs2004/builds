...
def speedtest(
    ...
    line3 = '[COLOR %s]Retrieving speedtest.net server list...[/COLOR]' \
        % COLOR2
    dp.update(4, line1+'[CR]'+line2+'[CR]'+line3)
    ...
    dp.update(65, '[CR]'+line2+'[CR]'+line3)
    ...
    while ulspeed < 1:
        ...
        dp.update(65, '[CR][CR][COLOR ' + COLOR2
    ...
    dp.update(95, line1+'[CR]'+line2+'[CR]'+line3)
