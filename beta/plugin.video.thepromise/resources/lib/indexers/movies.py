...
# UserLists WolfGirl Movies
        self.wgpicks_link = 'https://www.imdb.com/list/ls083232792/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.wgaction_link = 'https://www.imdb.com/list/ls044844213/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.wgapocolypse_link = 'https://www.imdb.com/list/ls044846463/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.wgxmas_link = 'https://www.imdb.com/list/ls086865651/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%sstart=1' % self.items_per_page
        self.wgcomedy_link = 'https://www.imdb.com/list/ls044846446/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.wgdocs_link = 'https://www.imdb.com/list/ls093271498/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%sstart=1' % self.items_per_page
        self.wgsleepy_link = 'https://www.imdb.com/list/ls086468369/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%sstart=1' % self.items_per_page
        self.wgmonster_link = 'https://www.imdb.com/list/ls044849542/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%sstart=1' % self.items_per_page
        self.wgparanormal_link = 'https://www.imdb.com/list/ls095238183/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%sstart=1' % self.items_per_page
        self.wgtoons_link = 'https://www.imdb.com/list/ls087391412/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.wgvault_link = 'https://www.imdb.com/list/ls090769563/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%sstart=1' % self.items_per_page
        self.wgbond_link = 'https://www.imdb.com/list/ls509091190/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%sstart=1' % self.items_per_page

# UserLists Cable Movies
        self.cablemovie_link = 'https://www.imdb.com/list/ls094498894/?view=detail&sort=alpha,asc&title_type=movie,tvMovie&keywords=female-nudity&count=%s&start=1' % self.items_per_page
        #self.cableNAME2_link = 'https://www.imdb.com/list/LISTNUMBER/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page

# UserLists ShadowHawk Movies
        self.shjaysilentbob_link = 'https://www.imdb.com/list/ls093291118/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.shstonermovies_link = 'https://www.imdb.com/list/ls093291705/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.shmontypython_link = 'https://www.imdb.com/list/ls093293549/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.shchechchong_link = 'https://www.imdb.com/list/ls093297505/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page

# UserLists DocOctyl
        self.dosyfy_link = 'https://www.imdb.com/list/ls096704404/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.dodrivein_link = 'https://www.imdb.com/list/ls096764156/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.douniverse_link = 'https://www.imdb.com/list/ls096764530/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.dopota_link = 'https://www.imdb.com/list/ls096704370/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.dotimetravel_link = 'https://www.imdb.com/list/ls096762438/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page

# UserLists insomnia
        self.icreep_link = 'https://www.imdb.com/list/ls500371586/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.ipicks_link = 'https://www.imdb.com/list/ls500375959/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.ispace_link = 'https://www.imdb.com/list/ls500348581/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page
        self.iwildw_link = 'https://www.imdb.com/list/ls500842793/?sort=release_date,desc&st_dt=&mode=detail&count=%s&start=1' % self.items_per_page
        self.idocs_link = 'https://www.imdb.com/list/ls500889584/?sort=release_date,desc&st_dt=&mode=detail&count=%s&start=1' % self.items_per_page

# UserLists Burnin U
        self.bumovies_link = 'https://www.imdb.com/list/ls043815558/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page

# UserLists DcMarvelBuild
        self.dcmarvelbuild_link = 'https://www.imdb.com/list/ls083241114/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page

# DC Comics Movies
        self.dcmovies_link = 'https://www.imdb.com/list/ls083349485/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page

# Marvel Movies
        self.marvelmovies_link = 'https://www.imdb.com/list/ls083349442/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page

# Superhero Collection
        self.superhero_link = 'https://www.imdb.com/list/ls083349908/?view=detail&sort=alpha,asc&title_type=movie,tvMovie,desc&count=%s&start=1' % self.items_per_page

# Documentaries
        self.docs_link = 'https://www.imdb.com/search/title/?title_type=feature,tv_movie,short&genres=documentary&count=%s&start=1' % self.items_per_page
