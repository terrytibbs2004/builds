...
class sources:
    ...
    def getConstants(self):
        ...
        if externalEnabled == 'true':
            try:
                import promisescrapers
                self.sourceDict += promisescrapers.sources()
                self.module_name = 'PromiseScrapers (' + str(control.addon('script.module.promisescrapers').getSetting('package.folder')) + ' set):' \
                                   if control.addon('script.module.promisescrapers').getSetting('package.folder') != 'Promisescrapers' else 'PromiseScrapers:'
            except:
                pass
