...
class source:
    def __init__(self):
        try:
            self.results = []
            self.domains = ['watchseries1.cyou', '123moviesfree.mom', '123movieshub.cfd', '123moviesready.org', 'the123movies.cam', '123movies.directory']
...
# Ditched for shitty results like https://hqq.to
