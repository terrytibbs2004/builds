...
DEBUGPREFIX = '[ Moria {0} | {1} | {2} | DEBUG ]'.format(version, kodi_version, sys_platform)
INFOPREFIX = '[ Moria | INFO ]'
...
def log(msg, trace=0):
    ...
    try:
        ...
        try:
            xbmc.log('Moria Logging Failure: %s' % e, LOGDEBUG)
        except:
            pass
