...
class tvshows:
    def __init__(self):
        ...
        self.binge_link = 'https://api.trakt.tv/users/istoit/lists/binge-box-tv2/items'
    ...
    def networks(self):
        networks = [
            ('A&E', '129', 'https://i.imgur.com/GzODPk7.png'),
            ('ABC', '2', 'https://i.imgur.com/b7rIHH4.png'),
            ('Acorn TV', '2697', 'https://i.imgur.com/Ac5ygjs.png'),
            ...
            ('CBS All Access', '1709', 'https://i.imgur.com/Pyn9iIt.png'),
            ...
            ('Crackle', '928', 'https://i.imgur.com/5JOCsIJ.png'),
            ('CTV', '110', 'https://i.imgur.com/qUlyVHz.png'),
            ('Curiosity Stream', '2349', 'https://i.imgur.com/BBr6nzt.png'),
            ('DC Universe', '2243', 'https://i.imgur.com/tW5RGg2.png'),
            ('Discovery Channel', '64', 'https://i.imgur.com/UxPqYg6.png'),
            ('Disney+', '2739', 'https://i.imgur.com/bwtYWuM.png'),
            ('Disney Channel', '54', 'https://i.imgur.com/pztjKLY.png'),
            ('Disney XD', '44', 'https://i.imgur.com/PAJJoqQ.png'),
            ('E!', '76', 'https://i.imgur.com/3Delf9f.png'),
            ('E4', '136', 'https://i.imgur.com/frpunK8.png'),
            ('Epix', '922', 'https://i.imgur.com/GIv2C2x.png'),
            ('FOX', '19', 'https://i.imgur.com/4ORECKc.png'),
            ('Freeform', '1267', 'https://i.imgur.com/f9AqoHE.png'),
            ('FX', '88', 'https://i.imgur.com/HzbkgVY.png'),
            ('FXX', '1035', 'https://i.imgur.com/Ur3FsXw.png'),
            ('Hallmark Channel', '384', 'https://i.imgur.com/f5cYQbd.png'),
            ('HBO Max', '3186', 'https://i.imgur.com/nSKN524.png'),
            ...
            ('Hulu', '453', 'https://i.imgur.com/Fx137j5.png'),
            ...
            ('Nick Junior', '35', 'https://i.imgur.com/xsWs6Ao.png'),
            ('Nickelodeon', '13', 'https://i.imgur.com/OUVoqYc.png'),
            ('Paramount+', '4330', 'https://i.imgur.com/AcQs62x.png'),
            ('Paramount Network', '2076', 'https://i.imgur.com/nVNSZLm.png'),
            ('PBS', '14', 'https://i.imgur.com/r9qeDJY.png'),
            ('Showtime', '67', 'https://i.imgur.com/SawAYkO.png'),
            ('Sky Atlantic', '1063', 'https://i.imgur.com/Poi44Qm.png'),
            ('Sky One', '214', 'https://i.imgur.com/xbgzhPU.png'),
            ('Spike', '55', 'https://i.imgur.com/ylBR50v.png'),
            ...
            ('The WB', '21', 'https://i.imgur.com/wmwh2Sa.png'),
            ('TLC', '84', 'https://i.imgur.com/c24MxaB.png'),
            ('TNT', '41', 'https://i.imgur.com/nUDLMzy.png'),
            ...
            ('YouTube Premium', '1436', 'https://i.imgur.com/5Jje8qZ.png')
        ]
