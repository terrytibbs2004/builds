...
colorChart = ['black', 'goldenrod', 'whitesmoke', 'gainsboro', 'lightgray', 'silver', 'darkgray', 'gray', 'dimgray',
              ...
              'powderblue', 'goldenrod', 'skyblue', 'lightskyblue', 'deepskyblue', 'dodgerblue', 'royalblue',
              ...
              'darkkhaki', 'goldenrod', 'gold', 'goldenrod', 'lightyellow', 'lightgoldenrodyellow', 'lemonchiffon',
              'yellow', 'seashell', 'lavenderblush', 'lavender', 'lightcoral', 'indianred', 'darksalmon',
              'lightsalmon', 'goldenrod', 'lightpink', 'hotpink', 'goldenrod', 'plum', 'violet', 'orchid', 'palevioletred',
