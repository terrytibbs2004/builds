...
##-- Nightwing add-on's debrid cache check module adjusted for Nightwing/Nightwing code base - all credits to Nightwing --##
...
class ADapi:
    def __init__(self):
        ...
        self.user_agent = 'Nightwing for Kodi'
...
class DLapi:
    def __init__(self):
        ...
        self.user_agent = 'URLResolver for Kodi/{0}'.format(__r_url__.getAddonInfo('version'))
