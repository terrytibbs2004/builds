...
from thelabscrapers.modules import cleantitle, client, source_utils, log_utils
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.domains = [ 'get.myvideolinks.net']
        self.base_link = custom_base or 'https://new.myvideolinks.net'
