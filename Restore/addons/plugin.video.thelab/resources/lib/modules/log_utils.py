...
DEBUGPREFIX = '[ TheLab {0} | {1} | {2} | DEBUG ]'.format(version, kodi_version, sys_platform)
INFOPREFIX = '[ TheLab | INFO ]'
...
def log(msg, trace=0):
    ...
    try:
        ...
        try:
            xbmc.log('TheLab Logging Failure: %s' % e, LOGDEBUG)
        except:
            pass
