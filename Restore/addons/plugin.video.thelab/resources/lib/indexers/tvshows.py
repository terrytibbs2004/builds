...
class tvshows:
    def __init__(self):
        ...
        self.traktanticipated_link = 'https://api.trakt.tv/shows/anticipated?limit=%s&page=1' % self.items_per_page
...
# User Lists BlairWitch
        self.blairwitch_link = 'https://www.imdb.com/list/ls564909129/?view=detail&sort=date_added,desc&title_type=tvSeries,tvMiniSeries&count=%s&start=1' % self.items_per_page
