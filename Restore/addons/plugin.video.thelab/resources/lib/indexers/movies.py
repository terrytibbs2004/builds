...
class movies:
    def __init__(self):
        ...
        self.traktanticipated_link = 'https://api.trakt.tv/movies/anticipated?limit=%s&page=1' % self.items_per_page
...
# UserLists Frakenstein
        self.frankentstein_link = 'https://www.imdb.com/list/ls031241505/?view=detail&sort=date_added,desc&title_type=movie,short,tvMovie,video&count=%s&start=1' % self.items_per_page
            ...
            try:
                ...
                try:
                    ...
                    if (premiered == '0' and status in ['Rumored', 'Planned', 'In Production', 'Post Production', 'Upcoming']) or (int(re.sub('[^0-9]', '', premiered)) > int(re.sub('[^0-9]', '', str(self.today_date)))):
                        label = '[COLOR magenta]%s [I][Upcoming][/I][/COLOR]' % label
                except:
                    pass
