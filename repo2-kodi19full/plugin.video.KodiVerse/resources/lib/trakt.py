...
API_KEY = '4f5cb24817c0192ab308a8c3f9a1d0d4844be046b4872317eb2d2145f0186399'
API_SECRET = '68dd9c57c27090904c14e9e9b71fb68d6937e2408955d8a5e666a259f824b5ef'
API_VERS = '2'
...
class cTrakt:
    ...
    def getLoad(self):
        ...
        if self.ADDON.getSetting('bstoken') == '':
            ...
            oOutputParameterHandler.addParameter('siteUrl', 'https://')
            oOutputParameterHandler.addParameter('type', 'movie')
            oGui.addDir(SITE_IDENTIFIER, 'search', self.ADDON.VSlang(30330), 'basic.png', oOutputParameterHandler)
        ...
        if (total > 0):
            ...
            for i in result:
                ...
                if 'collection' in sUrl:
                    ...
                    sTitle = ('[COLOR lime]%s %s [/COLOR]- %s %s') % (sType, 'vu', sTitle, sExtra)
            ...
            if (sPage < sMaxPage):
                ...
                oGui.addNext(SITE_IDENTIFIER, 'getTrakt', '[COLOR lime]Suivant >>>[/COLOR]', oOutputParameterHandler)
    ...
    def getContext(self):
        ...
        lang.append('[COLOR lime]' + self.ADDON.VSlang(30222) + ' ' + self.ADDON.VSlang(30310) + '[/COLOR]')
        ...
        lang.append('[COLOR lime]' + self.ADDON.VSlang(30222) + ' ' + self.ADDON.VSlang(30311) + '[/COLOR]')
        ...
        lang.append('[COLOR lime]' + self.ADDON.VSlang(30222) + ' ' + self.ADDON.VSlang(30312) + '[/COLOR]')
    ...
    def createContexTrakt(self, oGui, oGuiElement, oOutputParameterHandler=''):
        ...
        liste = []
        liste.append(['[COLOR lime]' + self.ADDON.VSlang(30221) + ' ' + self.ADDON.VSlang(30310) + '[/COLOR]', URL_API + 'sync/collection'])
        liste.append(['[COLOR lime]' + self.ADDON.VSlang(30222) + ' ' + self.ADDON.VSlang(30310) + '[/COLOR]', URL_API + 'sync/collection/remove'])
        liste.append(['[COLOR lime]' + self.ADDON.VSlang(30221) + ' ' + self.ADDON.VSlang(30311) + '[/COLOR]', URL_API + 'sync/watchlist'])
        liste.append(['[COLOR lime]' + self.ADDON.VSlang(30222) + ' ' + self.ADDON.VSlang(30311) + '[/COLOR]', URL_API + 'sync/watchlist/remove'])
        liste.append(['[COLOR lime]' + self.ADDON.VSlang(30221) + ' ' + self.ADDON.VSlang(30312) + '[/COLOR]', URL_API + 'sync/history'])
        liste.append(['[COLOR lime]' + self.ADDON.VSlang(30222) + ' ' + self.ADDON.VSlang(30312) + '[/COLOR]', URL_API + 'sync/history/remove'])
