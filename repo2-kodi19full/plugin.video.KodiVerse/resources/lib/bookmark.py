...
#         sTitle = cUtil().CleanName(sTitle)
    ...
    def getBookmarks(self):
        ...
        if compt[0] > 0:
            ...
            oGui.addDir(SITE_IDENTIFIER, 'getFav', '[COLOR lime]Erreur /!\ lien à supprimer!!! (' + str(compt[0]) + ')[/COLOR]', 'mark.png', oOutputParameterHandler)
    ...
    def getFav(self):
        ...
        for data in gen:
            ...
            try:
                ...
                oGui.addDir(SITE_IDENTIFIER, 'DoNothing', '[COLOR lime]ERROR[/COLOR]', 'films.png', oOutputParameterHandler)
