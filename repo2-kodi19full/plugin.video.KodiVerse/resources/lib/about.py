...
# sLibrary = xbmc.translatePath('special://home/addons/plugin.video.mando').decode('utf-8')
        ...
        if dialogs.VSyesno(addons.VSlang(30456)):
            ...
            if result:
                ...
                for i in result['files']:
                    ...
                    if 'plugin.video.mando' in i['filename']:
                        ...
                        try:
                            ...
                            # site += 'Add: [B]%s[/B] | Del: [B]%s[/B] | [COLOR lime]%s[/COLOR][CR]' % (i['additions'], i['deletions'], i['filename'].encode('utf-8'))
                            add += i['additions']
                            dell += i['deletions']
                            sdown = sdown + 1
                            schange += i['changes']
                        except:
                            # site += "[COLOR lime]" + i['filename'].encode("utf-8") + "[/COLOR][CR]"
                            sdown = sdown + 1
                            pass
                ...
                icon = 'special://home/addons/plugin.video.mando/resources/art/update.png'
