...
def next_level(url,icon,fanart,plot,name,id):
    ...
    if change_regex:
        ...
        for link, image, name, date, summary in m:
            ...
            all_d.append(aa)
    if next_page:
        aa=addDir3('[COLOR lime][I]Next page[/I][/COLOR]','metacritic',193,'https://thumbs.dreamstime.com/b/next-page-icon-trendy-design-style-isolated-white-background-vector-simple-modern-flat-symbol-web-site-mobile-logo-135740961.jpg','https://i.imgur.com/vWRnI5B.png','Next page',id=url)
        all_d.append(aa)
