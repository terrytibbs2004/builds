...
def next_level(url,icon,fanart,plot,name,id):
    ...
    if 'movies' in id:
        ...
        if not COLOR2 == "":
            ...
            myPage = "Next Page >>"
        aa=addDir3('[COLOR lime][I]Next page[/I][/COLOR]','imdburl',193,'https://thumbs.dreamstime.com/b/next-page-icon-trendy-design-style-isolated-white-background-vector-simple-modern-flat-symbol-web-site-mobile-logo-135740961.jpg','https://i.imgur.com/vWRnI5B.png','Next page',id='movies$$$$$http://www.imdb.com/'+next_page)
        all_d.append(aa)
        ...
        if not COLOR2 == "":
            ...
            myPage = "Next Page >>"
        aa=addDir3('[COLOR lime][I]Next page[/I][/COLOR]','imdburl',193,'https://thumbs.dreamstime.com/b/next-page-icon-trendy-design-style-isolated-white-background-vector-simple-modern-flat-symbol-web-site-mobile-logo-135740961.jpg','https://i.imgur.com/vWRnI5B.png','Next page',id='tvshows/$$$$$http://www.imdb.com/'+next_page)
        all_d.append(aa)
        ...
        if not COLOR2 == "":
            ...
            myPage = "Next Page >>"
        aa=addDir3('[COLOR lime][I]Next page[/I][/COLOR]','imdburl',193,'https://thumbs.dreamstime.com/b/next-page-icon-trendy-design-style-isolated-white-background-vector-simple-modern-flat-symbol-web-site-mobile-logo-135740961.jpg','https://i.imgur.com/vWRnI5B.png','Next page',id='genres/$$$$$http://www.imdb.com/'+next_page)
        all_d.append(aa)
    elif 'genrestv/' in id:
        if '$$$$$' in id:
        ...
        log.warning(next_page)
        aa=addDir3('[COLOR lime][I]Next page[/I][/COLOR]','imdburl',193,'https://thumbs.dreamstime.com/b/next-page-icon-trendy-design-style-isolated-white-background-vector-simple-modern-flat-symbol-web-site-mobile-logo-135740961.jpg','https://i.imgur.com/vWRnI5B.png','Next page',id='genrestv/$$$$$http://www.imdb.com/'+next_page)
        all_d.append(aa)
