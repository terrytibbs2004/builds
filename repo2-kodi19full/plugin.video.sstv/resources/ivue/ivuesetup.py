...
import os,shutil,zipfile,re,string,time
import datetime
...
def iVueInt():
	...
	iVue_SETTINGS = transPath(os.path.join('special://home/userdata/addon_data/script.ivueguide','settings.xml'))
	UseriVueSets = transPath(os.path.join('special://home/userdata/addon_data/script.ivueguide','oldsettings.xml'))
	iVueSet = transPath(os.path.join('special://home/addons/plugin.video.droidentertainment/resources/ivue','ivuesettings.xml'))
	iVueFold = transPath(os.path.join('special://home/addons/plugin.video.droidentertainment/resources/ivue'))
	iVue_DATA = transPath(os.path.join('special://home/userdata/addon_data/script.ivueguide/'))
...
def install(name,url):
    path = transPath(os.path.join('special://home/addons','packages'))
    dp = xbmcgui.DialogProgress()
