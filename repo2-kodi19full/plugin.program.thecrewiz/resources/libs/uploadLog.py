...
class Main:
    ...
    def getFiles(self):
        ...
        if self.crashlog:
            ...
            if xbmc.getCondVisibility('system.platform.osx'):
                ...
                wiz.log("Windows crashlogs are not supported, please disable this option in the addon settings", LOGNOTICE)
                ...
                wiz.log("Android crashlogs are not supported, please disable this option in the addon settings", LOGNOTICE)
            ...
            if len(items) == 0:
                wiz.log("No crashlog file found", LOGNOTICE)
        return logfiles
    ...
    def readLog(self, path):
        try:
            ...
            if content:
                ...
                wiz.log('file is empty', LOGNOTICE)
                return False, "File is Empty"
        except:
            wiz.log('unable to read file', LOGNOTICE)
    ...
    def postLog(self, data, name):
        ...
        try:
            ...
            wiz.log("URL for %s: %s" % (name, page_url), LOGNOTICE)
    ...
    # def email_Log(self, email, results, file):
        ...
        # try:
            ...
            # wiz.log(str(returninfo), LOGNOTICE)
        # except Exception as e:
            # a = 'failed to connect to the server'
            # wiz.log("%s: %s" % (a, str(e)), xbmc.LOGERROR)
            # return False, a
