...
ORDER          = ['gaia', 'openmeta', 'thecrew', 'homelander', 'moria', 'premiumizer', 'realizer', 'seren', 'myaccounts', 'trakt']
...
TRAKTID = {
    ...
    'moria': {
        ...
        'saved'    : 'moria',
        'path'     : os.path.join(ADDONS, 'plugin.video.moria'),
        'icon'     : os.path.join(ADDONS, 'plugin.video.moria', 'icon.png'),
        'fanart'   : os.path.join(ADDONS, 'plugin.video.moria', 'fanart.jpg'),
        'file'     : os.path.join(TRAKTFOLD, 'thecrew_trakt'),
        'settings' : os.path.join(ADDOND, 'plugin.video.moria', 'settings.xml'),
        'default'  : 'trakt.user',
        'data'     : ['trakt.refresh', 'trakt.token', 'trakt.user'],
        'activate' : 'RunPlugin(plugin://plugin.video.moria/?action=authTrakt)'},
    'seren': {
        'name'     : 'Seren',
