...
import xbmc, xbmcaddon, xbmcgui, xbmcplugin, xbmcvfs, re, os, glob, _thread
...
def main():
    class enableAll():
        def __init__(self):
            self.databasepath = transPath('special://database/')
            self.addons       = transPath('special://home/addons/')
            self.tempauto     = transPath('special://home/addons/service.autoexec/autoexec_temp.py')
    ...
    try:
        ...
        firstRun = enableAll()
        xbmcgui.Dialog().notification("AutoExec.py", "All Addons Enabled", xbmcgui.NOTIFICATION_INFO, 5000, False)
        xbmcvfs.delete('special://home/addons/service.autoexec/autoexec.py')
        xbmcvfs.copy('special://home/addons/service.autoexec/autoexec_temp.py', 'special://home/addons/service.autoexec/autoexec.py')
        xbmcvfs.delete('special://home/addons/service.autoexec/autoexec_temp.py')
    except Exception as e:
