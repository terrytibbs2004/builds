...
from moriascrapers import sources_moriascrapers
from moriascrapers.modules import control
from moriascrapers import providerSources, providerNames
...
def ScraperChoice():
    from moriascrapers import providerSources
...
def ToggleProviderAll(enable):
    from moriascrapers import providerNames
...
if action == "moriascrapersettings":
    control.openSettings('0.0', 'script.module.moriascrapers')


elif mode == "moriascrapersettings":
    control.openSettings('0.0', 'script.module.moriascrapers')
    ...
    sourceList = []
    sourceList = sources_moriascrapers.all_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All providers = %s' % sourceList,2)
    control.sleep(200)
    control.openSettings(query, "script.module.moriascrapers")
    ...
    sourceList = []
    sourceList = sources_moriascrapers.hoster_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Hoster providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_moriascrapers.all_foreign_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Foregin providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_moriascrapers.greek_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
#    xbmc.log('All Greek providers = %s' % sourceList,2)
    ...
    sourceList = []
    sourceList = sources_moriascrapers.torrent_providers
    for i in sourceList:
        source_setting = 'provider.' + i
        control.setSetting(source_setting, params['setting'])
