...
from homelanderscrapers import parse_qs, urlencode, quote_plus
from homelanderscrapers.modules import cleantitle, client, debrid, source_utils, log_utils, control
...
class source:
    def __init__(self):
        self.priority = 1
        self.language = ['en']
        self.tvsearch = 'https://torrentapi.org/pubapi_v2.php?app_id=homelander&token={0}&mode=search&search_string={1}&format=json_extended'
        self.msearch = 'https://torrentapi.org/pubapi_v2.php?app_id=homelander&token={0}&mode=search&search_imdb={1}&format=json_extended'
        self.token = 'https://torrentapi.org/pubapi_v2.php?app_id=homelander&get_token=get_token'
