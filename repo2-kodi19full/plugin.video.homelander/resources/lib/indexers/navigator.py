...
class navigator:
    ...
    def movies(self, lite=False):
        ...
        self.addDirectoryItem('[COLOR white]Movie Mosts[/COLOR]', 'movieMosts', 'featured.png', 'DefaultMovies.png')
        ...
        self.addDirectoryItem('[COLOR white]More IMDb Keywords[/COLOR]', 'movieKeywords2', 'imdb.png', 'DefaultMovies.png')
    ...
    def tvshows(self, lite=False):
        ...
        self.addDirectoryItem('[COLOR white]TV Show Mosts[/COLOR]', 'tvMosts', 'featured.png', 'DefaultTVShows.png')
    ...
    def tools(self):
        self.addDirectoryItem('[COLOR white][B]Homelander[/B] : Changelog[/COLOR]', 'changelog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32043, 'openSettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem(32079, 'homelanderscrapersettings', 'icon.png', 'DefaultAddonProgram.png', isFolder=False)
        ...
        if not control.condVisibility('System.HasAddon(script.module.orion)'):
            self.addDirectoryItem('[COLOR white][B]Orion[/B] : Install[/COLOR]', 'installOrion', 'orion.png', 'DefaultAddonProgram.png', isFolder=False)
        else:
        ...
        self.addDirectoryItem('[COLOR white][B]Homelander[/B] : Cache Functions[/COLOR]', 'cacheNavigator', 'tools.png', 'DefaultAddonProgram.png')
        self.addDirectoryItem('[COLOR white][B]Homelander[/B] : Log Functions[/COLOR]', 'logNavigator', 'tools.png', 'DefaultAddonProgram.png')
    ...
    def log_functions(self):
        self.addDirectoryItem('[COLOR white][B]Homelander[/B] : View Log[/COLOR]', 'viewLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[COLOR white][B]Homelander[/B] : Upload Log to Pastebin[/COLOR]', 'uploadLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
        self.addDirectoryItem('[COLOR white][B]Homelander[/B] : Empty Log[/COLOR]', 'emptyLog', 'tools.png', 'DefaultAddonProgram.png', isFolder=False)
