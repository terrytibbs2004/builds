    ...
    for items in m_pre:
        ...
        for yr,lk,nm in m:
            ...
            if show_original_year in yr and clean_name(original_title,1).lower()==nm.replace(':','%3a').lower():
                ...
                x=requests.get('https://soap2day.to'+lk,headers=cook[1],cookies=cook[0]).content
                y=x
                ...
                if tv_movie=='tv':
                    ...
                    y=requests.get('https://soap2day.to'+llk,headers=cook[1],cookies=cook[0]).content
                ...
                response=requests.post('https://soap2day.to/home/index/'+added, headers=cook[1],cookies=cook[0], data=data).content
